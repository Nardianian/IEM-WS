...
public:
    ...
    void drawLabel (Graphics& g, Label& label) override
    {
        ...
        // edit from IEM template --> no background for labels with backgroundcolor transparentWhite
        if (label.findColour(Label::ColourIds::backgroundColourId) != Colours::transparentWhite)
        {
            g.fillPath(p);
        }
