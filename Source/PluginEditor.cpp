...
WfsAudioProcessorEditor::WfsAudioProcessorEditor (WfsAudioProcessor& p,
    ...
    sourcePositionPad (audioProcessor.getWfsSpeakerArray())
{
    ...
    setResizeLimits (minWidth,
                     minHeightInPixels,
                     minWidth * maxSizeRatio,
                     minHeightInPixels * maxSizeRatio); // use this to create a resizable GUI
    ...
    cbOutputChannelsSettingAttachment.reset (
        new ComboBoxAttachment (valueTreeState,
    ...
    cbLoudspeakerArrangementAttachment.reset (new ComboBoxAttachment (valueTreeState,
                                                                      "loudspeakerArrangement",
                                                                      cbLoudspeakerArrangement));
    ...
    slNLoudspeakersAttachment.reset (
        new SliderAttachment (valueTreeState, "nLoudspeakers", slNLoudspeakers));
    ...
    slLoudspeakerArrayLength.setColour (Slider::ColourIds::rotarySliderOutlineColourId,
                                        Colours::green);
    slLoudspeakerArrayLength.setTextBoxStyle (Slider::TextBoxBelow,
                                              false,
                                              textBoxWidth,
                                              textBoxHeight);
    slLoudspeakerArrayLength.setNumDecimalPlacesToDisplay (2);
    slLoudspeakerArrayLength.setTextValueSuffix ("m");
    slLoudspeakerArrayLengthAttachment.reset (
        new SliderAttachment (valueTreeState, "loudspeakerArrayLength", slLoudspeakerArrayLength));
    ...
    slLoudspeakerArrayRadiusAttachment.reset (
        new SliderAttachment (valueTreeState, "loudspeakerRadius", slLoudspeakerRadius));
    ...
    sourcePositionPad.addElement (slListenerPositionX,
                                  slListenerPositionY,
                                  sourcePositionPad.getColours().source);
    sourcePositionPad.addElement (slSourcePositionX,
                                  slSourcePositionY,
                                  sourcePositionPad.getColours().listener);
    addAndMakeVisible (sourcePositionPad);
    slListenerPositionXAttachment.reset (
        new SliderAttachment (valueTreeState, "listenerPositionX", slListenerPositionX));
    slListenerPositionYAttachment.reset (
        new SliderAttachment (valueTreeState, "listenerPositionY", slListenerPositionY));
    slSourcePositionXAttachment.reset (
        new SliderAttachment (valueTreeState, "sourcePositionX", slSourcePositionX));
    slSourcePositionYAttachment.reset (
        new SliderAttachment (valueTreeState, "sourcePositionY", slSourcePositionY));
    ...
    lbLoudspeakerArrangement.setColour (Label::ColourIds::backgroundColourId,
    ...
    lbLoudspeakerArrayLength.setColour (Label::ColourIds::backgroundColourId,
                                        Colours::transparentWhite);
...
void WfsAudioProcessorEditor::timerCallback()
{
    ...
    if (audioProcessor.redrawLoudspeakers)
    {
        ...
        sourcePositionPad.setLoudspeakerArrayLength (
            *valueTreeState.getRawParameterValue ("loudspeakerArrayLength"));
        sourcePositionPad.setLoudspeakerRadius (
            *valueTreeState.getRawParameterValue ("loudspeakerRadius"));
        sourcePositionPad.setRotation (*valueTreeState.getRawParameterValue ("rotation"));
        sourcePositionPad.setLoudspeakerArrangementType (
            audioProcessor.getLoudspeakerArrangementType());
